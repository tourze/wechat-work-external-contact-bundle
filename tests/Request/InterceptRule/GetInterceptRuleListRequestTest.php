...
namespace WechatWorkExternalContactBundle\Tests\Request\InterceptRule;

use HttpClientBundle\Request\ApiRequest;
use PHPUnit\Framework\TestCase;
use WechatWorkBundle\Request\AgentAware;
use WechatWorkExternalContactBundle\Request\InterceptRule\GetInterceptRuleListRequest;
...
class GetInterceptRuleListRequestTest extends TestCase
{
    ...
    public function test_inheritanceChain(): void
    {
        ...
        $this->assertInstanceOf(\WechatWorkExternalContactBundle\Request\InterceptRule\GetInterceptRuleListRequest::class, $this->request);
    }
