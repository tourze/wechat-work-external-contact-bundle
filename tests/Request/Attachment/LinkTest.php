...
class LinkTest extends TestCase
{
    ...
    public function test_retrievePlainArray_structure(): void
    {
        ...
        $this->assertGreaterThanOrEqual(2, count($array['link']));
    ...
    public function test_plainArrayInterfaceImplementation(): void
    {
        ...
        $link = new Link();
        $link->setTitle('接口测试');
        $link->setUrl('https://interface.com');
        
        $this->assertTrue(method_exists($link, 'retrievePlainArray'));
        $this->assertTrue(is_callable([$link, 'retrievePlainArray']));
